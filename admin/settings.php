...
// ENFORCE SECURITY: Check if user is logged in AND holds the 'admin' role
requireRole('admin');
...
<head>
    ...
    <title>Admin Settings - Medicine Tracking Portal</title>
        ...
        <div class="p-4" style="border-top: 1px solid var(--border-color);">
            <div class="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="text-xs text-muted" style="margin: 0;">Administrator</p>
                </div>
            </div>
        </div>
    </aside>
